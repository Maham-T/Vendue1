                    ...
                    <table class="table bg-white table-striped table-sm table-bordered table-hover table-checkable order-column" id="sample_1">
                      <thead>
                          ...
                          ?>
                            ...
                            <tfoot>
                              <tr>
                                <th colspan="2">Submit your bid</th> 
                                <th><div class="form-group mb-0"> 
                                  <input type="number" class="form-control form-control-sm" name="bid_val" id="bid_val"   placeholder="Bid Value"  title="Please enter Bid Start Price">
                                 </div></th>
                                <th> <button type="submit" name="AddOrUpdate" id="AddOrUpdate" class="btn btn-sm   btn-success btn-flat">
